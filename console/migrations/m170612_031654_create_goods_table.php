 ...
 */
class m170612_031654_create_goods_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        $this->createTable('goods', [
            ...
            'brand_id'=>$this->integer()->comment('商品分类'),
            'makert'=>$this->decimal(10,2)->comment('市场价格'),
            'shop_price'=>$this->decimal(10,2)->comment('商品价格'),
            'stock'=>$this->integer()->comment('库存'),
            'is_on_sale'=>$this->integer(1)->comment('是否在售1售，0下架'),
            'status'=>$this->integer(1)->comment('状态,1正常，0回收'),
