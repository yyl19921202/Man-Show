...
<div class="nav w1210 bc mt10">
    ...
    <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
        ...
        <div class="cat_bd">
            <?php foreach ($shops as $shop):?><!--遍历一级分类-->
            <div class="cat">
                <h3><a href=""><?=$shop->name?></a><b></b></h3>
                <div class="cat_detail">
                    <?php foreach ($shop->children as $child):?><!--//遍历二级分类-->
                    <dl class="dl_1st">
                        <dt><a href=""><?=$child->name?></a></dt>
                        <dd>
                            <?php foreach ($child->children as $cat):?><!--//三级分类遍历-->
                            <a href=""><?=$cat->name?></a>
                            <?php endforeach;?><!--//三级分类结尾-->
                        </dd>
                    </dl>
                    <?php endforeach;?><!--//二级分类结尾-->
                </div>
            </div>
            <?php endforeach;?><!--//一级分类结尾-->
        </div>
            ...
            <div class="service_wrap">
                ...
                <div class="game none">
                    <ul>
                        ...
                        <li><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/taohua.jpg'))?></a></li>
...
<div class="floor1 floor w1210 bc mt10">
            ...
            <div class="goodslist_wrap">
                <div>
                    <ul>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/thinkpad e420.jpg'))?></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/samsung6800.jpg'))?></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/lh531.jpg'))?></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/qinghuax2.jpg'))?></a></dt>
                ...
                <div class="none">
                    <ul>
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/thinkpad.jpg'))?></a></dt>
                                <dd><a href="">ThinkPad E42014英寸笔..</a></dd>
                                <dd><span>售价：</span> <strong>￥4199.00</strong></dd>
                            </dl>
                        </li>
    ...
    <div class="sidebar fl ml10">
        ...
        <div class="brand">
            ...
            <div class="sidebar_wrap">
                <ul>
                    <li><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/dell.jpg'))?></a></li>
                    <li><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/acer.jpg'))?></a></li>
                    ...
                    <li><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/samsung.jpg'))?></a></li>
                    <li><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/dlink.jpg'))?></a></li>
