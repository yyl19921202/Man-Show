        ...
        <div class="summary">
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <li class="<?=$k==0?'cur':''?>">
                                <a class="<?=$k==0?'zoomThumbActive':''?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage:<?="http://admin.yii2shop.com".$img->img?>,largeimage:<?="http://admin.yii2shop.com".$img->img?>}">
                                    <img src="<?="http://admin.yii2shop.com".$img->img?>">
                                </a>
                            </li>
                            <?php endforeach;?>
                        </ul>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li class="market_price"><span>定价：</span><em><?=$goods->makert_price?></em></li>
                    ...
                    <li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有29845人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
                <form action="<?=\yii\helpers\Url::to(['user/cart'])?>" method="post" class="choose">
                    <ul>
            ...
            <div class="detail_bd">
                ...
                <div class="comment detail_div mt10">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""> <?=\yii\helpers\Html::img(Yii::getAlias('@web/images/user1.jpg'))?></a></dt>
                                <dd><a href="">乖乖</a></dd>
                            </dl>
                        </div>
                        <div class="item">
