            ...
            <dl>
                ...
                <dd>
                    ...
                    <div class="viewlist mt10">
                        <h3>最近浏览的商品：</h3>
                        <ul>
                            <li><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/ad.jpg'))?></a></li>
                            <li><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/ad.jpg'))?></a></li>
                            <li><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/ad.jpg'))?></a></li>
                        </ul>
                    </div>
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><a href="http://www.yii2shop.com/user/goods.html?id=<?=$good->id?>"><img src="<?='http://admin.yii2shop.com'.$good->logo?>"></a></dt>
